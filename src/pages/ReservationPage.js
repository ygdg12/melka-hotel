...
const ROOM_TYPES = [
  { value: 'standard-single', label: 'Standard Single — from 4,449 ETB/night' },
  { value: 'standard-delux', label: 'Standard Delux — from 5,549 ETB/night' },
  { value: 'double-delux', label: 'Double Delux — from 7,249 ETB/night' },
  { value: 'twin-delux', label: 'Twin Delux — from 8,899 ETB/night' },
  { value: 'triple-deluxe-suite', label: 'Triple Deluxe Suite — from 13,299 ETB/night' },
  { value: 'family-suite', label: 'Family Suite — from 12,999 ETB/night' },
];
