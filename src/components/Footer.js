    ...
    <div className="footer-bottom">
      ...
      <div className="footer-socials">
        {[
          ...
          Icon
            ? <a key={label} href="/" onClick={(e) => e.preventDefault()} aria-label={label} className="footer-social-btn"><Icon size={14} /></a>
            : <a key={label} href="/" onClick={(e) => e.preventDefault()} aria-label={label} className="footer-social-btn">
